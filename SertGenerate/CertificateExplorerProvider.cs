...
namespace SertGenerate
{
    ...
    {
        private string[] certStores = new string[] { 
            "LocalMachine.My", 
            "CurrentUser.My", 
            "LocalMachine.Root", 
            "CurrentUser.Root" };
        ...
        private const string LOCAL_MACHINE_ROOT = "Локальный компьютер - Доверенные корневые центры";
        private const string CURRENT_USER_ROOT = "Текущий пользователь - Доверенные корневые центры";
        ...
        public List<X509Certificate2Wrapper> Certificates { get { return certList; } }
